...
<?php get_header(); ?>
                ...
                <div class="row">
                    <div class="col-md-12 single-container ">
                        <div style="float:none;" class="col-md-12 jumbotron caption centered">
                            <h2 class="down-button">
                                <a id="searching"><?php echo $post->post_title?></a>
                            </h2>
        ...
        <section class="container contactt white">
            <div class="row">
                <h2 id="titular">Haz tus consultas aquí</h2>
                <div class="line-green"></div>
            </div>
        </section>
        ...
        <section class="container white" style="overflow:auto">
            ...
            <div class="col-md-12 chat-consult" id="searching">
        ...
        <script>
            jQuery(document).ready(function () {
                ...
                jQuery("#searching").click(function(){
                    jQuery('html, body').animate({
                        scrollTop: jQuery('#titular').offset().top
                    }, 'slow');
                });
            });
        </script>
